...
export const metadata: Metadata = {
  title: { default: "MUCO LABS Intern", template: "%s · MUCO LABS Intern" },
  description: "Your internship: dates, assigned work, learning and your certificate.",
  metadataBase: new URL("https://intern.mucolabs.com"),
