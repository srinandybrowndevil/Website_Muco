    ...
    <div className="authpage">
      ...
      <aside className="authaside">
        ...
        <div className="stack-sm">
          <h2>Everything the studio knows, and a record of who changed it.</h2>
          <p>People, projects, grants, certificates, compensation and the audit trail. Disabling somebody here closes every door immediately, on all four workspaces, without deleting the work they did.</p>
        </div>
        <p className="notice">
