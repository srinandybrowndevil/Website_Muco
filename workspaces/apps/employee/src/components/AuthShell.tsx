    ...
    <div className="authpage">
      ...
      <aside className="authaside">
        ...
        <div className="stack-sm">
          <h2>Your projects, your tasks, your pay.</h2>
          <p>You see the projects you are assigned to and nothing else. Your compensation is yours alone — no one else in the studio can open it, including other employees.</p>
        </div>
        <p className="notice">
