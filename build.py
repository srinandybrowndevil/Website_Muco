...
LOGO_SVG = """<svg class="logo-mark" viewBox="0 0 100 100" fill="none" aria-hidden="true" focusable="false">
          <g transform="translate(10, 10)">
            <path d="M12 66 V26 L26 16 V56 Z" fill="#0d0d0d"/>
            <path d="M12 26 L26 16 L38 24 L24 34 Z" fill="#b4b4b0"/>
            <path d="M24 34 L38 24 L52 48 L38 58 Z" fill="#5c5c5c"/>
            <path d="M52 48 L42 32 L56 22 L66 38 Z" fill="#0d0d0d"/>
            <path d="M56 22 L70 12 L70 52 L56 62 Z" fill="#5c5c5c"/>
            <path d="M42 62 L56 52 L56 68 L42 78 Z" fill="#0d0d0d"/>
          </g>
        </svg>"""
