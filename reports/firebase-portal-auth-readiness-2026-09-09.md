...
The read-only setup check confirms HTTP 200 reachability for all CRM tables and the live lead endpoint rejects an empty payload with the expected validation errors. It does not submit a real enquiry, send email, or create a CRM record.
